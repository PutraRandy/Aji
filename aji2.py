...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token="EpQOlSWQDJ6NaELXlAW4.x6EvjLE74Nmu1Wo4pafGra.I2/++bF/DJym2wI3XBtTg49OofSL4t3rqZEdDzXSy2s=")
kr.loginResult()
...
Bots=[mid]
admin=["u5fa7952657bbe27314d703b83c016044","u73fed7f31bf5f7a20875dfc90f026121","u350cc7408cc6cc82e056ee046131f925",mid]
...
#========================== FOR COMMAND BOT STARTING =============================#
                ...
                msg.contentMetadata = {'mid': "u350cc7408cc6cc82e056ee046131f925"}
                kr.sendMessage(msg)
                kr.sendText(msg.to,'Creator yang manis ganteng dan kalem  􀜁􀄯􏿿')
...
#==============================================#
        ...
        if op.type == 17:
           if wait["Wc"] == True:
               ...
               kr.sendText(op.param1, "Selamat Datang Di  " + str(ginfo.name) + "\n╠═════════════\n" + "║Founder =>>> " + str(ginfo.name) + " :\n║" + ginfo.creator.displayName + "\n╠═════════════\n" + "║😊Semoga Betah Kak 😘 ")
               print "MEMBER HAS JOIN THE GROUP"
        if op.type == 15:
            if wait["Lv"] == True:
                if op.param2 in Bots:
                    return
                kr.sendText(op.param1, "Baper Ya :v \n║Semoga Bahagia ya 😊 ")
    ...
    for zx in range(0,10):
      ...
      if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
        try:
          ...
          kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By:􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳� 👈 »»» http://line.me/ti/p/jkp4678«««")
          print "Like"
        except:
          pass
      else:
        ...
        if hasil['result']['posts'][zx]['postInfo']['liked'] == False:
            if hasil['result']['posts'][zx]['userInfo']['mid'] in mid:
                try:
                    ...
                    kr.comment(hasil['result']['posts'][zx]['userInfo']['mid'],hasil['result']['posts'][zx]['postInfo']['postId'],"👉ąµţ๏ℓɨЌ€ By:􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺T-B-A༻ 􀂳� 👈 »»» http://line.me/ti/pa/jkp4679«««")
                    print "Like"
                except:
                    pass
            else:
