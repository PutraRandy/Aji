...
kr1 = KRIS.LINE()
#kr1.login(qr=True)
kr1.login(token="EpQOlSWQDJ6NaELXlAW4.x6EvjLE74Nmu1Wo4pafGra.I2/++bF/DJym2wI3XBtTg49OofSL4t3rqZEdDzXSy2s=")
kr1.loginResult()

kr2 = KRIS.LINE()
#kr2.login(qr=True)
kr2.login(token="EoCKUp44FfsyQF4GkHO1.C+7x8XV196iiDD+jdWjHiq.P7p93vh9roDow3RaKTuDrlbRmUHnUXqeXlg64pmYh7A=")
kr2.loginResult()

kr3 = KRIS.LINE()
#kr3.login(qr=True)
kr3.login(token="EoVAsfIBS9WcceArwYnc.ldCwnKyK9HhZJYE3Bchm+a.aHQFlPk8NQdjAuTIE779Aa4/lE7tHYSq0T9S1wxV3Yo=")
kr3.loginResult()

kr4 = KRIS.LINE()
#kr4.login(qr=True)
kr4.login(token="EoGNeW0X6kIVjd3hWsAc.CBFySchkaDp6D9pw5Rmnda.fdul+24Yv59J1AChtaMvsdPzogksxOKR3ZxvTxIa1Uc=")
kr4.loginResult()
...
["u73fed7f31bf5f7a20875dfc90f026121"]
mid3 = kr3.getProfile().mid
["u2c3716364624f611f38f27b76c21ccfc"]
mid4 = kr4.getProfile().mid
["u71b7d8b021ca01d3fa77d3d6e6b30d0c"]
#mid5 = kr5.getProfile().mid
#mid6 = kr6.getProfile().mid

Bots=[mid,mid2,mid3,mid4]
owner=["u5fa7952657bbe27314d703b83c016044","u73fed7f31bf5f7a20875dfc90f026121"]
admin=["u5fa7952657bbe27314d703b83c016044","u73fed7f31bf5f7a20875dfc90f026121",mid,mid2,mid3,mid4]
...
wait = {
    ...
    "dblack":False,
    "clock":False,
    "cNames1":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺Bang-aji༻ 􀂳􏿿",
    "cNames2":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺E-L ༻ 􀂳􏿿",
    "cNames3":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺DUL༻ 􀂳􏿿",
    "cNames4":"􀰂􀰂􀰂􀰂􀠁􀠁􀠁 ༺A L ༻ 􀂳􏿿",
