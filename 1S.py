...
kr = KRIS.LINE()
#kr.login(qr=True)
kr.login(token="EpUSY0hyv6G4SdyGWwx5.nqZhqiZgZilGvU4eyth5jq.UQJZDIg3z2wF1qEJdeX7Om1fDoqaSdRWL7I3kVJfhGE=")
kr.loginResult()
...
helpMessage ="""
╔════════════════════════
║Creator by BA [Babang-Adhi]
║Owner :􀰂􀰂􀰂􀰂􀠁􀠁􀠁􀰂􀰂􀰂􀰂􀠁􀠁􀠁 􀂳�BA
╚════════════════════════
║Key1
║Key2
║Key3
...
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid"u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32","uf44a92c0c62be1ff5a7e7a73758aad4f","u0548e577b8d144d19d36617941d15062","ub51bc97c5e4f603f1dff35e9512550d3","u354baee4aaeb83f15cdf3f72be757ba9"]
induk=["u350cc7408cc6cc82e056ee046131f925"]
asist=[Amid,Bmid,Cmid,Dmid,Emid,"uc2e8b426f6591045943eae5304e67c32","uf44a92c0c62be1ff5a7e7a73758aad4f","u0548e577b8d144d19d36617941d15062","ub51bc97c5e4f603f1dff35e9512550d3","u354baee4aaeb83f15cdf3f72be757ba9"]
admin=["u350cc7408cc6cc82e056ee046131f925","uc2e8b426f6591045943eae5304e67c32",Amid,Bmid,Cmid,Dmid,Emid]
...
wait = {
    ...
    "autoAdd":True,
    "detectMention":True,
    "message":"👉😊☆ºhttp://line.me/ti/p/jkp4678",
    "lang":"JP",
    "comment":"👉😊http://line.me/ti/p/~jkp4678",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#==========================[Kris]===========================
					...
					if wait["lang"] == "JP":
						kr1.sendText(msg.to,key1)
					else:
						random.choice(AST).sendText(msg.to,key1)
            elif msg.text in ["Key1","key1"]:
					if wait["lang"] == "JP":
						kr1.sendText(msg.to,key2)
					else:
						random.choice(AST).sendText(msg.to,key2)
